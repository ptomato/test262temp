...
const TOO_MANY_TESTS = 5;  // more than this will be collapsed in <details>
...
function loadResults() {
  ...
  for (const file of files) {
    ...
    for (const test of data) {
      ...
      if (pass === undefined || message === undefined) {
        errors.push(`**${engineKey}**: Unexpected format of results in ${file} for ${relative} (${Object.keys(result)})`);
        continue;
      }
      ...
      engineResults[resultKey] = { pass, message };
    }
  }
